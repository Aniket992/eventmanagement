                  ...
                  <div className="  flex flex-col p-5 text-center justify-center  items-center    ">
                    ...
                    <div className="w-full flex flex-col gap-7 ">
                      ...
                      <div className="flex justify-evenly">
                        {event.ruleBook && (
                          <button
                            className="bg-green-500  text-black font-avenger tracking-widest text-2xl font-bold p-3 w-fit rounded-full"
              ...
              <div className="  w-1/2 flex flex-col justify-between p-5   ">
                ...
                <div className=" h-full text-center flex  flex-col justify-between pb-5 w-full ">
                  ...
                  <div className="mb-5">
                    ...
                    <p className="  font-bold text-xl  ">
                      {" "}
                      {event.organiserName && event.organiserName}
                    </p>
                  </div>
                  <div className=" w-full font-bold  ">
                    <h4 className="font-avenger tracking-widest text-green-600 text-2xl font-bold">
                      Contact:
                    </h4>
                    {event.contacts &&
                      event.contacts.map((contact, index) => (
                        <div key={index} className="  font-bold text-xl ">
                          <p>Name: {contact.name && contact.name}</p>
                          <p className="">
